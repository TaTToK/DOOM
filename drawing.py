...
class Drawing:
    def __init__(self, sc, sc_map, player, clock):
        ...
        self.weapon_shot_animation = deque([pygame.image.load(
            f'sprites/weapons/shotgun/shot/0.png').convert_alpha()
                                            for i in range(20)])
        ...
        # sfx parameters
        self.sfx = deque([pygame.image.load(f'sprites/weapons/sfx/0.png').convert_alpha() for i in range(9)])
